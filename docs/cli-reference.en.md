...
- [Configuration Reference](configuration.md) — Full field documentation for `agent.json`
- [Plugin Development Guide](plugin-development.md) — How to write and register custom plugins
- [Seams & Extension Points](seams-and-extension-points.md) — Seam responsibilities and decision tree
- [API Reference](api-reference.md) — Core types: `Runtime`, `RunRequest`, `RunResult`, and more
