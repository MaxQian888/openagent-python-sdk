...
- [配置参考](../configuration/configuration.md) — `agent.json` 的完整字段说明
- [插件开发指南](../plugins/plugin-development.md) — 如何编写并注册自定义插件
- [Seam 与扩展点](../architecture/seams-and-extension-points.md) — 各 seam 的职责与决策树
- [API 参考](../reference/api-reference.md) — `Runtime`、`RunRequest`、`RunResult` 等核心类型
