...
!!! note "Seam consolidation (0.3.0)"
    ...
    Migration details and code examples are in [`seams-and-extension-points.en.md`](../architecture/seams-and-extension-points.en.md) §2.
...
- [Seams and Extension Points](../architecture/seams-and-extension-points.en.md)
- [Configuration Reference](../configuration/configuration.md)
- [Plugin Development](../plugins/plugin-development.md)
- [API Reference](../reference/api-reference.md)
- [Examples](examples.md)
- [Streaming API](../reference/stream-api.md)
- [Observability](../reference/observability.md)
- [0.2 → 0.3 Migration Guide](../migration/migration-0.2-to-0.3.md)
- [Error reference (errors.en.md)](../reference/errors.en.md) — dotted codes, retryable classification, and recommended handling per exception class
