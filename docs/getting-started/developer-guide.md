...
!!! note "Seam 合并说明（0.3.0）"
    ...
    迁移详情与代码示例见 [`seams-and-extension-points.md`](../architecture/seams-and-extension-points.md) §2。
...
细节见 [内置 CLI 参考](../cli/cli.md)（英文：[cli.en.md](../cli/cli.en.md)）。
...
- [内置 CLI 参考](../cli/cli.md)
- [示例说明](examples.md)
- [流式 API](../reference/stream-api.md)
- [可观测性](../reference/observability.md)
- [0.2 → 0.3 迁移指南](../migration/migration-0.2-to-0.3.md)
- [错误参考 / errors.md](../reference/errors.md) — 每个 `OpenAgentsError` 子类的 code、retryable、处理建议
