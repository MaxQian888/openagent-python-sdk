...
- Want to learn custom plugin / seam development
  - Read [Plugin Development](../plugins/plugin-development.md) first
...
Further reading: [multi-agent-support-example](../guides/multi-agent-support-example.en.md) — a walkthrough of the four scenarios, naming the `agent-router` spec requirement each exercises.
...
4. [Plugin Development](../plugins/plugin-development.md)
...
- CLI guide: [`docs/pptx-agent-cli.en.md`](../guides/pptx-agent-cli.en.md) ([CN](../guides/pptx-agent-cli.md))
