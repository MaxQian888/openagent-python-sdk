...
- 想学自定义 plugin / seam
  - 先读 [插件开发](../plugins/plugin-development.md)
...
进一步阅读：[multi-agent-support-example](../guides/multi-agent-support-example.md) —— 四个场景逐个走，每个场景标注它行使了 `agent-router` 规范的哪条契约。
...
4. [插件开发](../plugins/plugin-development.md)
...
- 详细 CLI 说明：[`docs/pptx-agent-cli.md`](../guides/pptx-agent-cli.md)（[EN](../guides/pptx-agent-cli.en.md)）
