...
- [docs/seams-and-extension-points.md](../architecture/seams-and-extension-points.md)
- [docs/examples.md](examples.md)

Other key documents:

- [docs/configuration.md](../configuration/configuration.md) — JSON configuration reference
- [docs/plugin-development.md](../plugins/plugin-development.md) — plugin development guide
- [docs/api-reference.md](../reference/api-reference.md) — Python API reference
- [docs/builtin-tools.md](../reference/builtin-tools.md) — builtin tools catalog
- [docs/stream-api.md](../reference/stream-api.md) — streaming API (`run_stream`) reference
- [docs/cli-reference.md](../cli/cli-reference.md) — CLI command reference (`openagents schema/validate/list-plugins`)
- [docs/observability.md](../reference/observability.md) — structured logging and observability
- [docs/event-taxonomy.md](../configuration/event-taxonomy.md) — event taxonomy table
- [docs/migration-0.2-to-0.3.md](../migration/migration-0.2-to-0.3.md) — migration guide
...
- `skills/openagent-agent-builder/` — agent construction helper skill; see [docs/openagent-agent-builder.md](../skills/openagent-agent-builder.md)
