...
- [docs/configuration.md](../configuration/configuration.md) — JSON 配置参考
- [docs/plugin-development.md](../plugins/plugin-development.md) — 插件开发指南
- [docs/api-reference.md](../reference/api-reference.md) — Python API 参考
- [docs/builtin-tools.md](../reference/builtin-tools.md) — 内置工具目录
- [docs/stream-api.md](../reference/stream-api.md) — 流式 API（`run_stream`）参考
- [docs/cli-reference.md](../cli/cli-reference.md) — CLI 命令参考（`openagents schema/validate/list-plugins`）
- [docs/observability.md](../reference/observability.md) — 结构化日志与可观测性
- [docs/event-taxonomy.md](../configuration/event-taxonomy.md) — 事件分类表
- [docs/migration-0.2-to-0.3.md](../migration/migration-0.2-to-0.3.md) — 迁移指南
...
- `skills/openagent-agent-builder/` — agent 构建辅助 skill；详见 [docs/openagent-agent-builder.md](../skills/openagent-agent-builder.md)
