...
!!! warning
    If you have cached agent builder output from an older version (0.2.x format), re-run the builder or manually replace `execution_policy: filesystem` with `tool_executor: filesystem_aware`. See [migration-0.2-to-0.3.md](migration-0.2-to-0.3.md) for details.
