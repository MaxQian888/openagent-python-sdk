...
The Event Bus is configured in the top-level `events` field of your config file. See [Configuration Reference](../configuration/configuration.md).
...
- [Configuration Reference](../configuration/configuration.md) — Full JSON schema for the `logging` and `events` blocks
- [Plugin Development Guide](../plugins/plugin-development.md) — Writing a custom Event Bus plugin
- [Seams & Extension Points](../architecture/seams-and-extension-points.md) — Decision tree for the `events` seam
