...
!!! warning
    如果你有缓存的旧版 agent builder 输出（0.2.x 格式），请重新运行 builder 或手动将 `execution_policy: filesystem` 替换为 `tool_executor: filesystem_aware`。详见 [migration-0.2-to-0.3.md](../migration/migration-0.2-to-0.3.md)。
