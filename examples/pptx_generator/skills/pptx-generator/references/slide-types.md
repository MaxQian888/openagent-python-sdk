...
4. **Verify**: Generate `slide-XX-preview.pptx`. Extract text with `markitdown slide-XX-preview.pptx -o slide-XX-preview.md`, then verify all content is present and no placeholder text remains.
...
5. **Verify**: Generate a preview, extract text with `markitdown`, and verify the content plus page badge.
...
4. **Verify**: Generate a preview, extract text with `markitdown`, and verify the content plus page badge.
...
4. **Verify**: Generate `slide-XX-preview.pptx`. Extract text with `markitdown slide-XX-preview.pptx -o slide-XX-preview.md`, then verify all content is present, no placeholder text remains, and the page badge is included.
